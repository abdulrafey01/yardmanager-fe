  ...
  return (
    ...
    >
      ...
      <div className="w-full relative z-[60] h-screen flex justify-center items-center">
        {/* Modal container */}
        <div className="bg-white p-4 w-1/3 rounded-lg flex flex-col space-y-8">
          {/* First row */}
          ...
          <div className="flex space-x-4">
            <div className="flex p-4 justify-center items-center border border-gray-300 rounded-lg flex-1 hover:bg-gray-300 cursor-pointer">
              Cancel
            </div>
            <div
              onClick={() => {
              ...
              className="flex bg-[#D32F2F] p-4 justify-center items-center border border-gray-300 rounded-lg flex-1 text-white hover:bg-[#B71C1C] cursor-pointer"
            >
              Yes, Delete
            </div>
          </div>
