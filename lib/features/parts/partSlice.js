...
export const partSlice = createSlice({
  ...
  reducers: {
    ...
    resetPartSearchData: (state) => {
      state.partSearchData = [];
    },
  },
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchAllParts.rejected, (state, action) => {
...
export const { resetPartToast, resetPartSearchData } = partSlice.actions;
